        ...
        <div className="w-full">
            ...
            <div className="mx-auto w-full max-w-7xl flex items-center justify-between py-4 px-12">
                ...
                <a href="mailto:jordan.lcq1@gmail.com" className="text-white">
                    <div className="mx-auto inline-block px-6 py-3 my-10 bg-emerald-600 text-white transition-all font-semibold rounded-lg shadow-md hover:bg-emerald-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                        Contact Me
                    </div>
                </a>
            </div>
